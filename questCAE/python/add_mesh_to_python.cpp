...
namespace Quest::Python{
    ...
    roperties::Pointer GetPropertiesFromElement( Element& pelem ){
    ...
    void GetValuesOnIntegrationPoints(
        ...
        QUEST_ERROR << "GetValuesOnIntegrationPoints is deprecated. Use CalculateOnIntegrationPoints instead!" << std::endl;
    }
    ...
    {
        QUEST_ERROR_IF(values.size() != dummy.GetGeometry().IntegrationPointsNumber())
    ...
    void SetValuesOnIntegrationPointsArray1d(
        TObject& dummy,
        const Variable<Array1d<double, TSize>>& rVariable,
        pybind11::list values_list,
        const ProcessInfo& rCurrentProcessInfo
    ){
        std::vector<Array1d<double, TSize>> values(values_list.size());
        for (std::size_t i = 0; i < values_list.size(); i++) {
            if (py::isinstance<Array1d<double, TSize>>(values_list[i])) {
                values[i] = (values_list[i]).cast<Array1d<double, TSize> >();
                ...
                QUEST_ERROR_IF(value.size() != TSize)
                    << " parsed vector is not of size " << TSize << ". Size of vector: " << value.size() << std::endl;
                values[i] = value;
            } else {
                QUEST_ERROR << "expecting a list of Array1d<double, " << TSize << ">" << std::endl;
            }
        }
        dummy.SetValuesOnIntegrationPoints( rVariable, values, rCurrentProcessInfo );
    }
            ...
            const Variable<Vector>& rVariable, pybind11::list values_list, unsigned int len_values_list_item, const ProcessInfo& rCurrentProcessInfo )
    {
        ...
        for( std::size_t i=0; i<integration_points.size(); i++ ) {
            if(py::isinstance<Vector>(values_list[i]))
                ...
                QUEST_ERROR << "expecting a list of vectors";
        }
        dummy.SetValuesOnIntegrationPoints( rVariable, values, rCurrentProcessInfo );
    }
    ...
    void SetValuesOnIntegrationPointsConstitutiveLaw( Element& dummy, const Variable<ConstitutiveLaw::Pointer>& rVariable, pybind11::list values_list, const ProcessInfo& rCurrentProcessInfo ){
        ...
        for( unsigned int i=0; i<integration_points.size(); i++ ) {
            if(py::isinstance<ConstitutiveLaw::Pointer>(values_list[i]))
                ...
                QUEST_ERROR << "expecting a list of ConstitutiveLaw::Pointer";
        }
        dummy.SetValuesOnIntegrationPoints( rVariable, values, rCurrentProcessInfo );
    }
    ...
    void AddMeshToPython(pybind11::module& m){
        py::class_GeometricalObject, GeometricalObject::Pointer, IndexedObject, Flags>(m,"GeometricalObject")
            .def(py::init<Quest::GeometricalObject::IndexType>())
            .def("IsActive", &GeometricalObject::IsActive);


        py::class_<Element, Element::Pointer, Element::BaseType>(m,"Element")
            .def(py::init<Quest::Element::IndexType>())
            ...
            .def("__setitem__", SetValueHelperFunction< Element, Variable< Array1d<double, 3>  > >)
            .def("__getitem__", GetValueHelperFunction< Element, Variable< Array1d<double, 3>  > >)
            .def("Has", HasHelperFunction< Element, Variable< Array1d<double, 3>  > >)
            .def("SetValue", SetValueHelperFunction< Element, Variable< Array1d<double, 3>  > >)
            .def("GetValue", GetValueHelperFunction< Element, Variable< Array1d<double, 3>  > >)

            .def("__setitem__", SetValueHelperFunction< Element, Variable< Array1d<double, 4>  > >)
            .def("__getitem__", GetValueHelperFunction< Element, Variable< Array1d<double, 4>  > >)
            .def("Has", HasHelperFunction< Element, Variable< Array1d<double, 4>  > >)
            .def("SetValue", SetValueHelperFunction< Element, Variable< Array1d<double, 4>  > >)
            .def("GetValue", GetValueHelperFunction< Element, Variable< Array1d<double, 4>  > >)

            .def("__setitem__", SetValueHelperFunction< Element, Variable< Array1d<double, 6>  > >)
            .def("__getitem__", GetValueHelperFunction< Element, Variable< Array1d<double, 6>  > >)
            .def("Has", HasHelperFunction< Element, Variable< Array1d<double, 6>  > >)
            .def("SetValue", SetValueHelperFunction< Element, Variable< Array1d<double, 6>  > >)
            .def("GetValue", GetValueHelperFunction< Element, Variable< Array1d<double, 6>  > >)

            .def("__setitem__", SetValueHelperFunction< Element, Variable< Array1d<double, 9>  > >)
            .def("__getitem__", GetValueHelperFunction< Element, Variable< Array1d<double, 9>  > >)
            .def("Has", HasHelperFunction< Element, Variable< Array1d<double, 9>  > >)
            .def("SetValue", SetValueHelperFunction< Element, Variable< Array1d<double, 9>  > >)
            .def("GetValue", GetValueHelperFunction< Element, Variable< Array1d<double, 9>  > >)
            ...
            .def("CalculateOnIntegrationPoints", CalculateOnIntegrationPoints<Element, Array1d<double, 3>>)
            .def("CalculateOnIntegrationPoints", CalculateOnIntegrationPoints<Element, Array1d<double, 4>>)
            .def("CalculateOnIntegrationPoints", CalculateOnIntegrationPoints<Element, Array1d<double, 6>>)
            .def("CalculateOnIntegrationPoints", CalculateOnIntegrationPoints<Element, Array1d<double, 9>>)
            ...
            .def("Calculate", &EntityCalculateInterface<Element, Array1d<double,3> >)
            ...
            .def("CalculateSensitivityMatrix", &EntityCalculateSensitivityMatrix<Element, Array1d<double,3>>)
            ...
            .def("__setitem__", SetValueHelperFunction< Condition, Variable< Array1d<double, 3>  > >)
            .def("__getitem__", GetValueHelperFunction< Condition, Variable< Array1d<double, 3>  > >)
            .def("Has", HasHelperFunction< Condition, Variable< Array1d<double, 3>  > >)
            .def("SetValue", SetValueHelperFunction< Condition, Variable< Array1d<double, 3>  > >)
            .def("GetValue", GetValueHelperFunction< Condition, Variable< Array1d<double, 3>  > >)

            .def("__setitem__", SetValueHelperFunction< Condition, Variable< Array1d<double, 4>  > >)
            .def("__getitem__", GetValueHelperFunction< Condition, Variable< Array1d<double, 4>  > >)
            .def("Has", HasHelperFunction< Condition, Variable< Array1d<double, 4>  > >)
            .def("SetValue", SetValueHelperFunction< Condition, Variable< Array1d<double, 4>  > >)
            .def("GetValue", GetValueHelperFunction< Condition, Variable< Array1d<double, 4>  > >)

            .def("__setitem__", SetValueHelperFunction< Condition, Variable< Array1d<double, 6>  > >)
            .def("__getitem__", GetValueHelperFunction< Condition, Variable< Array1d<double, 6>  > >)
            .def("Has", HasHelperFunction< Condition, Variable< Array1d<double, 6>  > >)
            .def("SetValue", SetValueHelperFunction< Condition, Variable< Array1d<double, 6>  > >)
            .def("GetValue", GetValueHelperFunction< Condition, Variable< Array1d<double, 6>  > >)

            .def("__setitem__", SetValueHelperFunction< Condition, Variable< Array1d<double, 9>  > >)
            .def("__getitem__", GetValueHelperFunction< Condition, Variable< Array1d<double, 9>  > >)
            .def("Has", HasHelperFunction< Condition, Variable< Array1d<double, 9>  > >)
            .def("SetValue", SetValueHelperFunction< Condition, Variable< Array1d<double, 9>  > >)
            .def("GetValue", GetValueHelperFunction< Condition, Variable< Array1d<double, 9>  > >)
            ...
            .def("CalculateOnIntegrationPoints", CalculateOnIntegrationPoints<Condition, Array1d<double, 3>>)
            .def("CalculateOnIntegrationPoints", CalculateOnIntegrationPoints<Condition, Array1d<double, 4>>)
            .def("CalculateOnIntegrationPoints", CalculateOnIntegrationPoints<Condition, Array1d<double, 6>>)
            .def("CalculateOnIntegrationPoints", CalculateOnIntegrationPoints<Condition, Array1d<double, 9>>)
            ...
            .def("Calculate", &EntityCalculateInterface<Condition, Array1d<double,3> >)
            ...
            .def("CalculateSensitivityMatrix", &EntityCalculateSensitivityMatrix<Condition, Array1d<double,3>>)
